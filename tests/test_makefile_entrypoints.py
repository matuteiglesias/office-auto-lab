...
def test_smoke_is_core_only_and_legacy_compiler_is_compatibility_only() -> None:
    ...
    assert smoke_deps == ["imports", "control-contracts", "identity-contracts", "work-contracts", "staff-v2-contracts", "principal-contracts", "execution-contracts", "editorial-contracts", "runtime-contracts", "repo-scans"]
