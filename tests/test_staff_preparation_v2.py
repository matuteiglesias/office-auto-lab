                ...
                "rows": [
                    {
                        "artifact_id": "sa_1",
                        "front_id": "fr_decide",
                        "artifact_role": "DECISION_CONTEXT",
                        "artifact_kind": "URL",
                ...
                "rows": [
                    {
                        ...
                        "contract_version": "v1",
                        "allowed_powers": "read_state;write_artifacts",
                        "forbidden_powers": "external_send",
                    }
                ]
            },
...
def item(
    ...
    kind: str,
    *,
    principal_required: bool = False,
    prep_mode: str = "STAFF_REQUIRED",
...
class StaffPreparationV2Tests(unittest.TestCase):
    ...
    def test_every_item_is_triaged_but_deep_preparation_is_bounded(self) -> None:
        ...
        result = prepare_work_items(
            snapshot(),
            work_set(
                item("fr_exec", "EXECUTE"),
                item("fr_decide", "DECIDE", principal_required=True),
            ),
            adapters=[adapter],
            max_deep=1,
        ...
        # Principal-required work wins the bounded deep-prep frontier.
    ...
    def test_blocked_identity_does_not_invoke_expensive_adapter(self) -> None:
        ...
        blocked["identity"]["workspace_states"] = [
            {"repo_id": "repo.blocked", "workspace_id": None, "status": "AMBIGUOUS"}
        ]
    ...
    def test_maintenance_without_staff_requirement_stays_light(self) -> None:
        ...
        result = prepare_work_items(
            snapshot(),
            work_set(item("fr_maint", "MAINTAIN", prep_mode="NONE")),
            adapters=[adapter],
            max_deep=0,
        )
        packet = result["packets"][0]
