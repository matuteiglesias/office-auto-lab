...
class IdentityResolverV2Tests(unittest.TestCase):
    def test_execution_path_comes_only_from_repo_workspace_chain(self) -> None:
        ...
        self.assertEqual(context["primary_repository"]["workspace"]["local_path"], "/home/matias/repos/office-auto-lab")
    ...
    def test_binding_without_workspace_id_uses_unique_preferred_active_workspace(self) -> None:
        bindings = [{"binding_id": "rb_1", "front_id": "fr_0003", "repo_id": "repo.office-auto-lab", "workspace_id": "", "binding_role": "PRIMARY_IMPLEMENTATION", "is_primary": "TRUE", "binding_status": "ACTIVE"}]
        workspaces = [
            {"workspace_id": "ws_archive", "repo_id": "repo.office-auto-lab", "local_path": "/archive/office", "checkout_kind": "ARCHIVE", "workspace_status": "ACTIVE", "is_preferred": "FALSE"},
            {"workspace_id": "ws_live", "repo_id": "repo.office-auto-lab", "local_path": "/repos/office", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"},
        ]
    ...
    def test_multiple_active_workspaces_without_unique_preference_stay_ambiguous(self) -> None:
        bindings = [{"binding_id": "rb_1", "front_id": "fr_0003", "repo_id": "repo.office-auto-lab", "workspace_id": "", "binding_role": "PRIMARY_IMPLEMENTATION", "is_primary": "TRUE", "binding_status": "ACTIVE"}]
        workspaces = [
            {"workspace_id": "ws_a", "repo_id": "repo.office-auto-lab", "local_path": "/repos/a", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "FALSE"},
            {"workspace_id": "ws_b", "repo_id": "repo.office-auto-lab", "local_path": "/repos/b", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "FALSE"},
        ]
    ...
    def test_multiple_preferred_workspaces_are_contract_error(self) -> None:
        bindings = [{"binding_id": "rb_1", "front_id": "fr_0003", "repo_id": "repo.office-auto-lab", "workspace_id": "", "binding_role": "PRIMARY_IMPLEMENTATION", "is_primary": "TRUE", "binding_status": "ACTIVE"}]
        workspaces = [
            {"workspace_id": "ws_a", "repo_id": "repo.office-auto-lab", "local_path": "/repos/a", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"},
            {"workspace_id": "ws_b", "repo_id": "repo.office-auto-lab", "local_path": "/repos/b", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"},
        ]
    ...
    def test_explicit_workspace_must_belong_to_bound_repo(self) -> None:
        bindings = [{"binding_id": "rb_1", "front_id": "fr_0003", "repo_id": "repo.office-auto-lab", "workspace_id": "ws_wrong", "binding_role": "PRIMARY_IMPLEMENTATION", "is_primary": "TRUE", "binding_status": "ACTIVE"}]
        workspaces = [{"workspace_id": "ws_wrong", "repo_id": "repo.other", "local_path": "/repos/other", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"}]
    ...
    def test_multiple_primary_bindings_are_contract_error(self) -> None:
        bindings = [
            {"binding_id": "rb_1", "front_id": "fr_0003", "repo_id": "repo.office-auto-lab", "workspace_id": "ws_0134", "binding_role": "PRIMARY_IMPLEMENTATION", "is_primary": "TRUE", "binding_status": "ACTIVE"},
            {"binding_id": "rb_2", "front_id": "fr_0003", "repo_id": "repo.second", "workspace_id": "ws_second", "binding_role": "SUPPORTING", "is_primary": "TRUE", "binding_status": "ACTIVE"},
        ]
        workspaces = [
            {"workspace_id": "ws_0134", "repo_id": "repo.office-auto-lab", "local_path": "/repos/office", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"},
            {"workspace_id": "ws_second", "repo_id": "repo.second", "local_path": "/repos/second", "checkout_kind": "CHECKOUT", "workspace_status": "ACTIVE", "is_preferred": "TRUE"},
        ]
